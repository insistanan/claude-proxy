...
func RegisterRoutes(group *gin.RouterGroup, service *Service, management ...*AuditManagementService) error {
	...
	routes.GET("/identity-presets", handler.listAuditIdentityPresets)
	routes.GET("/capability-presets", handler.listAuditCapabilityPresets)
	routes.POST("/question-banks/reload", handler.reloadQuestionBanks)
	routes.GET("/mods", handler.listAuditMods)
	routes.GET("/mod-examples", handler.listAuditModExamples)
	routes.POST("/mods/reload", handler.reloadAuditMods)
	routes.POST("/mods/import", handler.importAuditMod)
	routes.POST("/mods", handler.createAuditMod)
	routes.GET("/mods/:id", handler.getAuditMod)
	routes.PUT("/mods/:id", handler.updateAuditMod)
	...
	routes.POST("/jobs/:id/retry", handler.retryAuditJob)
	...
	routes.GET("/runs/:id/analyses", handler.listAuditModAnalyses)
	routes.POST("/analyses/:id/manual-result", handler.importManualAuditModAnalysis)
	routes.POST("/analyses/:id/rerun", handler.rerunAuditModAnalysis)
