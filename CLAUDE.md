...
> Claude Code 工作指南。仓库协作规范见 AGENTS.md；项目知识与硬性规则**按需查 docs/，不复制、不背**（路由表见下）。
...
| 场景 | 先读 |
|---|---|
| 改渠道 / 调度 / 协议 / 流式链路 | `docs/flows.md`（主链路 + vision 旁路 + responses 例外）、`docs/ARCHITECTURE.md` |
...
| 开发 / 打包 / 发布 | `docs/DEVELOPMENT.md`（含 Windows exe 打包）、`docs/RELEASE.md` |
